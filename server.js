var fs = require('fs');
var shell = new require('./server/lib/util-shell');
...
app.use(express.session({ secret: 'NMS_JS' }));
...
//http://patorjk.com/software/taag/#p=display&h=0&v=0&f=Electronic&t=NMS.js
var logo = "*******************************************************************"
 + '\r\n' + " ▄▄        ▄  ▄▄       ▄▄  ▄▄▄▄▄▄▄▄▄▄▄     ▄▄▄▄▄▄▄▄▄▄▄  ▄▄▄▄▄▄▄▄▄▄▄   "
 + '\r\n' + "▐░░▌      ▐░▌▐░░▌     ▐░░▌▐░░░░░░░░░░░▌   ▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌ "
 + '\r\n' + "▐░▌░▌     ▐░▌▐░▌░▌   ▐░▐░▌▐░█▀▀▀▀▀▀▀▀▀     ▀▀▀▀▀█░█▀▀▀ ▐░█▀▀▀▀▀▀▀▀▀  "
...
function SHELL_CREATE(self, data){
     ...
     self.data({ shellname: data.shellname, data: logo });
     self.data({shellname:data.shellname, data: self[data.shellname].prompt});
}
